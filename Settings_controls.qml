...
Item {
    ...
    Slider {
        ...
        stepSize: 1
        to: 255
        value: Number(_Settting.Lcdlightget())
    ...
    Switch {
        ...
        height: 41
        text: "dasdad"
        checked: Number(_Settting.getCamera())
        checkable: true
        scale: 3
    ...
    Switch {
        ...
        height: 41
        text: "dasdad"
        checked: Number(_Settting.getSSH())
        checkable: true
        scale: 3
    ...
    Switch {
        ...
        height: 41
        text: "dasdad"
        checked: Number(_Settting.getI2C())
        checkable: true
        scale: 3
    ...
    Switch {
        ...
        height: 41
        text: "dasdad"
        checked: Number(_Settting.getSPI())
        checkable: true
        scale: 3
    ...
    Switch {
        ...
        height: 41
        text: "dasdad"
        checked: Number(_Settting.getVNC())
        checkable: true
        scale: 3
    ...
    Switch {
        ...
        height: 41
        text: "dasdad"
        checked: Number(_Settting.getSER())
        checkable: true
        scale: 3
